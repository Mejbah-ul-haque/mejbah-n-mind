...
import './CheckOut.css';
import img from '../../../Images/About/account.jpg'
                                ...
                                <div className="row g-0">
                                    ...
                                    <div className="col-xl-6">
                                        <div className="card-body p-md-5 text-black">
                                            <h3 className="mb-5 text-uppercase text-center">Create Account</h3>
                                            ...
                                            <div className="form-outline mb-4">
                                                ...
                                                <label className="form-label" for="form3Example99">Service Name</label>
                                            </div>
                                            ...
                                            <div className="d-flex justify-content-end pt-3">
                                                ...
                                                <button type="button" className="btn btn-success btn-lg ms-2">Submit</button>
                                            </div>
