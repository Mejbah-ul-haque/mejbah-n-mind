...
const ServiceDetail = () => {
    ...
    const {_id, name, project, features, bodyPart1, bodyPart2, bodyPart3, bodyPart4, image, image2, image3, image4, technologies, tools, live, clientCode, serverCode} = services;
    ...
    return (
        <div style={{ minHeight: '100vh' }} className='text-center container'>
            <h2 className='my-3 text-secondary'> {name}</h2>
            <p>
                <a target='_blank' href={clientCode}><button className='btn btn-outline-secondary m-3'>GitHub Client</button></a>
                <a target='_blank' href={live}><button className='btn btn-outline-secondary m-3'>Live site</button></a>
            ...
            <div className='row d-block mx-auto'>
               ...
               <div className="col-sm-12 col-lg-6  d-block mx-auto my-5"><p className='text-secondary text-start fs-5'>{bodyPart1}</p></div>
               <div className="col-sm-12 col-lg-8 my-4 d-block mx-auto"><img className='img-fluid' src={image2} alt=""></img></div>
               <div className="col-sm-12 col-lg-6  d-block mx-auto my-5"><p className='text-secondary fs-5 text-start'>{bodyPart2}</p></div>
               <div className="col-sm-12 col-lg-8 my-4 d-block mx-auto"><img className='img-fluid' src={image3} alt=""></img></div>
               <div className="col-sm-12 col-lg-6  d-block mx-auto my-5"><p className='text-secondary text-start fs-5'>{bodyPart3}</p></div>
               <div className="col-sm-12 col-lg-8 my-4 d-block mx-auto"><img className='img-fluid' src={image4} alt=""></img></div>
               <div className="col-sm-12 col-lg-6  d-block mx-auto my-5"><p className='text-secondary fs-5'>{bodyPart4}</p></div>
