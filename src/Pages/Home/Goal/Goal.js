    ...
    return (
        <div className='g-5 col-sm-12 col-md-6 col-lg-4 mb-4' >
            ...
            <div className=' rounded  text-center pb-4 px-4 goal-bo lead-shadow' style={{marginBottom:'100px'}}>
                <h1 className='mb-5 logo-bg '><span style={{backgroundColor: '#030303a7' }} className='rounded-circle p-4  text-secondary fw-bold lead-shadow '>{logo}<small className='fs-6 fw-normal'></small></span></h1>
