    ...
    return (
        <div className='gx-4 gy-5 col-sm-12 col-md-6 col-lg-4'>
            <div className='bg-light text-center pb-3'>
                ...
                <h5 className='mb-4'><span className='rounded-circle border border-3 border-light py-3 px-2 text-white' style={{ backgroundColor: 'gray' }}>${price}<small className='fs-6 fw-normal'>/m</small></span></h5>
